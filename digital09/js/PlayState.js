...
{	
	...
	create_hud: function()
	{
		...
		{
			this.altDisplay =  this.game.add.text(600, 2, "Altitude: " + 
		...
		// this.waterDisplay = this.game.add.text(150, 2, "Water: "+this.ship.water,
			// {fill:"white", font: "18px Courier", align: "center"});
		// hud.addChild(this.waterDisplay);
	},
	...
	update: function()
	{
		...
		// this.waterDisplay.text = "Water: "+ Math.floor((this.ship.water));
