...
SolarMapState.prototype = {
    ...
    create: function() {
        ...
        this.satellite.body.velocity.x = 2 * Math.cos(this.satellite.body.rotation - (Math.PI / 2));
        this.satellite.body.velocity.y = 2 * Math.sin(this.satellite.body.rotation - (Math.PI / 2));
        ...
        createCollisionGroup();
        this.game.physics.p2.updateBoundsCollisionGroup();
        this.asteroidBelt.body.setCollisionGroup(this.asteroidBelt.collisionGroup);
        /* Set other collision groups to collide with. */
